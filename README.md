...
| 42 | **Minor 9th Chords** (`minor-ninth-chord-trainer.html`) | How every m9 chord is built by counting semitones (a minor 7th chord (Lesson 15) with a 9th stacked on top), plus three MIDI exercises: all 12 minor 9th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 43 | **Minor 11th Chords** (`minor-eleventh-chord-trainer.html`) | How every m11 chord is built by counting semitones (a minor 9th chord (Lesson 42) with an 11th stacked on top), plus three MIDI exercises: all 12 minor 11th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 44 | **Minor 13th Chords** (`minor-thirteenth-chord-trainer.html`) | How every m13 chord is built by counting semitones (a minor 11th chord (Lesson 43) with a 13th stacked on top — the fullest stock minor 7th-family chord), plus three MIDI exercises: all 12 minor 13th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 45 | **Minor 6/9 Chords** (`minor-six-nine-chord-trainer.html`) | How every m6/9 chord is built by counting semitones (a minor 6th chord (Lesson 21) with a 9th stacked on top, and no 7th of any kind), plus three MIDI exercises: all 12 minor 6/9 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 46 | **Minor-Major 7th Chords** (`minor-major-seventh-chord-trainer.html`) | How every m(maj7) chord is built by counting semitones (a minor triad (Lesson 9) with a major 7th on top, instead of the minor 7th a plain minor 7th chord uses), plus three MIDI exercises: all 12 minor-Major 7th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 47 | **Minor-Major 9th Chords** (`minor-major-ninth-chord-trainer.html`) | How every m(maj9) chord is built by counting semitones (a minor-major 7th chord (Lesson 46) with a 9th stacked on top), plus three MIDI exercises: all 12 minor-Major 9th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 48 | **Major 9th Chords** (`major-ninth-chord-trainer.html`) | How every maj9 chord is built by counting semitones (a major 7th chord (Lesson 16) with a 9th stacked on top), plus three MIDI exercises: all 12 major 9th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 49 | **Major 13th Chords** (`major-thirteenth-chord-trainer.html`) | How every maj13 chord is built by counting semitones (a major 9th chord (Lesson 48) with a 13th stacked on top — the fullest stock major 7th-family chord), plus three MIDI exercises: all 12 major 13th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 50 | **Major 7th♯5 Chords** (`major-seventh-sharp-five-chord-trainer.html`) | How every maj7♯5 chord is built by counting semitones (an augmented triad (Lesson 10) with a major 7th on top, instead of the minor 7th an augmented 7th chord (Lesson 23) uses), plus three MIDI exercises: all 12 major 7th♯5 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 51 | **Dominant 9sus4 Chords** (`dominant-nine-sus4-chord-trainer.html`) | How every 9sus4 chord is built by counting semitones (a dominant 7sus4 chord (Lesson 29) with a 9th stacked on top), plus three MIDI exercises: all 12 dominant 9sus4 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 52 | **Dominant 13sus4 Chords** (`dominant-thirteen-sus4-chord-trainer.html`) | How every 13sus4 chord is built by counting semitones (a dominant 9sus4 chord (Lesson 51) with a 13th stacked on top), plus three MIDI exercises: all 12 dominant 13sus4 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 53 | **Major 7sus2 Chords** (`major-seventh-sus2-chord-trainer.html`) | How every maj7sus2 chord is built by counting semitones (a sus2 chord (Lesson 27) with a major 7th stacked on top), plus three MIDI exercises: all 12 major 7sus2 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 54 | **Major 7sus4 Chords** (`major-seventh-sus4-chord-trainer.html`) | How every maj7sus4 chord is built by counting semitones (a sus4 chord (Lesson 28) with a major 7th stacked on top, instead of the minor 7th a dominant 7sus4 chord (Lesson 29) uses), plus three MIDI exercises: all 12 major 7sus4 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 55 | **Add11 Chords** (`add11-chord-trainer.html`) | How every add11 chord is built by counting semitones (a major triad (Lesson 8) with an 11th (4th) added, keeping the 3rd — distinct from a sus4 chord (Lesson 28), which removes the 3rd), plus three MIDI exercises: all 12 add11 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 56 | **Diminished Major 7th Chords** (`diminished-major-seventh-chord-trainer.html`) | How every °(maj7) chord is built by counting semitones (a diminished triad (Lesson 11) with a major 7th on top, instead of the diminished 7th a diminished 7th chord (Lesson 14) uses), plus three MIDI exercises: all 12 diminished Major 7th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 57 | **Minor 7♭9 Chords** (`minor-seventh-flat-nine-chord-trainer.html`) | How every m7♭9 chord is built by counting semitones (a minor 7th chord (Lesson 15) with a ♭9th stacked on top, instead of the natural 9th a minor 9th chord (Lesson 42) uses), plus three MIDI exercises: all 12 minor 7♭9 chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 58 | **Half-Diminished 11th Chords** (`half-diminished-eleventh-chord-trainer.html`) | How every m11♭5 chord is built by counting semitones (a half-diminished 7th chord (Lesson 17) with a 9th and 11th stacked on top), plus three MIDI exercises: all 12 half-Diminished 11th chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 59 | **Power Chords** (`power-chord-trainer.html`) | How every 5 chord is built by counting semitones (just a root and a perfect 5th, with no 3rd at all — the simplest possible chord shape), plus three MIDI exercises: all 12 power chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 60 | **Split-Third Blues Chords** (`split-third-blues-chord-trainer.html`) | How every 7(♭3/♮3) chord is built by counting semitones (a dominant 7th chord (Lesson 13) with both the minor 3rd and major 3rd sounded together, instead of just the major 3rd), plus three MIDI exercises: all 12 split-third "blues" chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 61 | **Quartal Chords** (`quartal-chord-trainer.html`) | How every quartal chord is built by counting semitones (five notes stacked entirely in perfect 4ths, instead of the stacked 3rds every other chord in this app uses), plus three MIDI exercises: all 12 quartal chords around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
| 62 | **Tone Cluster Chords** (`tone-cluster-chord-trainer.html`) | How every cluster chord is built by counting semitones (three adjacent notes struck together — a half step and a whole step stacked right on top of the root, with no 3rd, 5th, or 7th at all), plus three MIDI exercises: all 12 tone clusters around the circle of fourths, and 5 jazz plus 5 gospel chord progressions built around this color, in every key |
...
├─ minor-ninth-chord-trainer.html # Lesson 42
├─ minor-eleventh-chord-trainer.html # Lesson 43
├─ minor-thirteenth-chord-trainer.html # Lesson 44
├─ minor-six-nine-chord-trainer.html # Lesson 45
├─ minor-major-seventh-chord-trainer.html # Lesson 46
├─ minor-major-ninth-chord-trainer.html # Lesson 47
├─ major-ninth-chord-trainer.html # Lesson 48
├─ major-thirteenth-chord-trainer.html # Lesson 49
├─ major-seventh-sharp-five-chord-trainer.html # Lesson 50
├─ dominant-nine-sus4-chord-trainer.html # Lesson 51
├─ dominant-thirteen-sus4-chord-trainer.html # Lesson 52
├─ major-seventh-sus2-chord-trainer.html # Lesson 53
├─ major-seventh-sus4-chord-trainer.html # Lesson 54
├─ add11-chord-trainer.html # Lesson 55
├─ diminished-major-seventh-chord-trainer.html # Lesson 56
├─ minor-seventh-flat-nine-chord-trainer.html # Lesson 57
├─ half-diminished-eleventh-chord-trainer.html # Lesson 58
├─ power-chord-trainer.html # Lesson 59
├─ split-third-blues-chord-trainer.html # Lesson 60
├─ quartal-chord-trainer.html # Lesson 61
├─ tone-cluster-chord-trainer.html # Lesson 62
